User.create!(email: "tc@example.com", first_name: "Tom", last_name: "Chulick", password_digest: "12412421")
User.create!(email: "pnc@example.com", first_name: "Pete", last_name: "Chulick", password_digest: "124124124")
User.create!(email: "abc@example.com", first_name: "Alberta", last_name: "Chulick", password_digest: "124124124")
User.create!(email: "pc@example.com", first_name: "Peter", last_name: "Chulick", password_digest: "124124124")
